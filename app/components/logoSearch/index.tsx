	...
	return (
		<div className='flex flex-col md:flex-row justify-between items-center gap-4 px-[10px] py-4 max-w-[1180px] mx-auto'>
			<div className='logo text-2xl font-bold w-full text-primary flex items-center justify-between gap-1'>
				<div>
					<Link
						className='flex items-center text-[27px] text-[#134E9B]'
						href={'/'}
					>
				...
				<div className=''>
					<p className='text-[#203F68] md:hidden font-semibold text-[14px]'>
						+998 (71) 123-45-67
					</p>
				</div>
			...
			<div className='flex gap-[5px] md:gap-[10px] sm:min-w-[400px] lg:min-w-[688px] w-full max-w-[688px] mx-auto'>
				...
				<div className='bg-[#EBEFF3] w-full flex min-w-[210px] rounded-[3px]'>
					<Input
			...
			<div className='icons hidden md:flex gap-3'>
				...
				{userData == null ? (
					<div
						className='w-[50px] h-[48px] bg-[#EBEFF3] flex text-[#545D6A] justify-center items-center rounded-[6px]'
						onClick={() => {
							setIsOpen(!isOpen)
						}}
					>
